...
export default function NewsCard({ item }) {
  return (
    <div className="m-5 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 group">
      <a href="#">
        <div className=" w-full overflow-hidden relative ">
          <Image
            width={208}
            height={208}
            className="rounded-t-lg w-full h-96 object-cover group-hover:scale-105  transition-all"
            src={item.src}
            alt={item.title}
          />
        </div>
